<script>
  ...
  function toggleHistorial() {
    ...
    if (mostrarHistorial) {
      obtenerHistorial(); // Si se muestra el historial, obtén los datos del servidor
    }
  }
</script>
...
<main>
  ...
  <div class="input-pad">
    ...
    <Keypad tamanio={2} tipoBoton="historial" clicked={obtenerHistorial,toggleHistorial}>Hist</Keypad>
